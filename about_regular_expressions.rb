...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # 
    # When there are no values to the left of the asterisk
  end
  ...
  # Repetition operators take as many values as possible 
  # that are matched while taking 
  # the original matched value as well.
  ...
  # My belief is that a character class gives you all that match
  # and alternation is only one of the matched values.
  # ------------------------------------------------------------------
